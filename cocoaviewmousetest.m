...
#define E(n) - (void)n:(NSEvent *)e { printEvent(#n, e, [self convertPoint:[e locationInWindow] fromView:nil]); }
E(mouseDown)
E(mouseDragged)
E(mouseUp)
E(rightMouseDown)
...
#define SETFONT(c) [(c) setFont:[NSFont systemFontOfSize:[NSFont systemFontSizeForControlSize:NSRegularControlSize]]];
	...
	testView *t = [[testView alloc]
		initWithFrame:NSMakeRect(20, 20, 360, 360)];
	ADD(t);
}
