...
static gboolean drawMidline(GtkWidget *w, cairo_t *cr, gpointer data)
{
	...
	cairo_move_to(cr, (a.width - a3.width) / 2, 0);
	cairo_line_to(cr, (a.width - a3.width) / 2, a.height);
	cairo_stroke(cr);
	cairo_move_to(cr, (a.width - a3.width), 0);
	cairo_line_to(cr, (a.width - a3.width), a.height);
	cairo_stroke(cr);
