...
class areaView : NSView {
	...
	private func updateLabel(e: NSEvent) {
		let pt = self.convertPoint(e.locationInWindow, fromView: nil)
...
func appLaunched() {
	var mainwin = NSWindow(
		...
		`defer`: true)
	var contentView = mainwin.contentView!
...
func addConstraints(view: NSView, _ constraint: String, _ views: [String: NSView]) {
